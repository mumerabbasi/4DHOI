...
Left Foot: The left foot is in contact with the target object. Use solid #0000FF / RGB(0, 0, 255) (pure blue).
Right Foot: The right foot is in contact with the target object. Use solid #00FFFF / RGB(0, 255, 255) (pure cyan).
Left Hand: The left hand is in contact with the target object. Use solid #FF00FF / RGB(255, 0, 255) (pure magenta).
...
- Left Foot: required contact with target object 'wooden staircase, side walls'. Use #0000FF / RGB(0, 0, 255) (pure blue). SIG note: the left foot stands on a stair tread
- Right Foot: required contact with target object 'wooden staircase, side walls'. Use #00FFFF / RGB(0, 255, 255) (pure cyan). SIG note: the right foot stands on another stair tread for support
- Left Hand: required contact with target object 'wooden staircase, side walls'. Use #FF00FF / RGB(255, 0, 255) (pure magenta). SIG note: the left hand touches a side wall for balance
- Right Hand: required contact with target object 'wooden staircase, side walls'. Use #00FF00 / RGB(0, 255, 0) (pure green). SIG note: the right hand touches the opposite side wall for support
- Interaction description: A person stands at the end of the wooden staircase with both feet planted on the stair treads. Both arms reach outward so the left and right hands touch the side walls for balance and support. The person has short dark hair, a steady focused facial expression, a gray shirt, blue jeans, and white sneakers.

Correction instructions from the VLM evaluator:
The blue left-foot mask and the cyan right-foot mask are missing from the stair treads. Please add a blue mask on the lower stair tread where the left foot is planted and a cyan mask on the higher stair tread where the right foot is planted, as seen in the reference image. The magenta left-hand mask and green right-hand mask are currently placed on the vertical wall edges, but they should be placed on the corresponding side walls where the hands are actually touching, slightly lower down to match the reference hand positions.
