...
- Left Hand: required contact with target object 'coffee maker'. Use #0000FF / RGB(0, 0, 255) (pure blue). SIG note: the left hand steadies or holds the coffee maker area
- Right Hand: required contact with target object 'coffee maker'. Use #00FF00 / RGB(0, 255, 0) (pure green). SIG note: the right hand operates the coffee maker
...
Keep the original canvas unchanged. Move the blue left-hand mask down and slightly to the left, onto the lower-left side of the coffee maker, to better match the contact area in the reference image. Move the green right-hand mask down and slightly to the right, onto the lower-front-right side of the coffee maker, to better match the contact area in the reference image. Consider making both masks slightly larger to represent the contact footprint more accurately.
