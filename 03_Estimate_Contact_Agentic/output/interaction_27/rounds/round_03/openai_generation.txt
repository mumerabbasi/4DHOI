...
Move the green left-hand mask downward and slightly right onto the vertical side-glass edge where the hand grips in the reference; it is currently too high. Move the blue left-foot mask slightly right/down and make it a bit larger, centered on the visible foot contact area on the pink towel/inner bathtub ledge.
