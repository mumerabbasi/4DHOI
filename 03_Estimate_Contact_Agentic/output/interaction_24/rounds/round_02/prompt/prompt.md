...
The cyan right-hand mask is placed too high on the ceiling/wall; move it down to the top surface of the cupboard where the right hand is actually touching. The magenta left-foot mask and blue right-foot mask are incorrectly placed on seperate ladder steps. They should be placed on the top step.