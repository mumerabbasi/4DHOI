...
The cyan right-hand mask is too small and slightly shifted. Make the cyan mask larger to represent the contact area of the grasping hand, and move it down and slightly to the right, placing it precisely on the vertical edge of the curtain where the right hand is grasping it in the reference image.
