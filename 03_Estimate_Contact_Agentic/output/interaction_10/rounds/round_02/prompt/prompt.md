...
The red left-hand mask and the green right-hand mask on the vacuum cleaner handle are too small and too close together. In the reference image, the hands are spaced further apart to grip the handle properly. Please enlarge both masks and separate them vertically to match the actual grip positions on the vacuum cleaner handle.
