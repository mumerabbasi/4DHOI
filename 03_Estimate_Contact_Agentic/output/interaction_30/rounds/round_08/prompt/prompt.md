...
Keep the original canvas unchanged. The yellow left-hand and magenta right-hand masks are acceptable. Move the red left-foot mask downward to the lower ladder step/rung where the raised foot contacts in the reference, not the higher rung. Move the green right-foot mask farther down and slightly to the right onto the lowest visible step/rung where the lower foot rests in the reference. Keep both foot masks small and focused on the rung contact footprints.
