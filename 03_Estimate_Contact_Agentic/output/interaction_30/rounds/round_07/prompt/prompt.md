...
Keep the yellow left-hand mask on the left vertical rail. Move the magenta right-hand mask down from the top of the rail onto the upper horizontal rung/left frame area where the upper hand grips in the reference. Move the red left-foot mask lower onto the rung directly under the raised foot contact. Move the green right-foot mask lower/right onto the lower step where the descending foot contacts the ladder.
