...
Move the magenta right-hand mask down from the top of the left rail to the upper hand contact location shown in the reference: a small mask on the left side of the ladder at the upper rung/side-frame area where the hand grips, not near the top cap. Keep the yellow left-hand mask on the lower left vertical rail, and keep the red and green foot masks on their respective ladder steps if unchanged.
