...
Move the magenta right-hand mask onto the actual upper hand contact on the ladder, on the horizontal/side frame area near the upper rung where the hand grips, not floating on the wall. Keep the yellow left-hand mask on the left vertical rail but adjust it to the visible lower hand grip height if needed. Move the red left-foot mask downward onto the rung directly under the upper foot in the reference, and move the green right-foot mask downward onto the lower rung/step under the lower foot. Keep all masks small and focused on the contact footprints only.
