...
Left Hand: The left hand is in contact with the target object. Use solid #00FFFF / RGB(0, 255, 255) (pure cyan).
...
- Left Hand: required contact with target object 'pull-up bar'. Use #00FFFF / RGB(0, 255, 255) (pure cyan). SIG note: the left hand grips the pull-up bar
- Right Hand: required contact with target object 'pull-up bar'. Use #0000FF / RGB(0, 0, 255) (pure blue). SIG note: the right hand grips the pull-up bar
- Interaction description: A person hangs from the pull-up bar with elbows bent and knees tucked upward. The left hand grips the pull-up bar, the right hand grips the pull-up bar, the left foot stays off the floor, and the right foot stays off the floor. The person has short black hair, a strained focused facial expression, a gray athletic shirt, dark shorts, and sneakers.
...
The hand contact locations are approximately correct, but the colors are swapped for the person's body sides. Keep the original canvas unchanged and swap the mask colors: put the cyan left-hand mask on the viewer-right grip location, and put the blue right-hand mask on the viewer-left grip location.
