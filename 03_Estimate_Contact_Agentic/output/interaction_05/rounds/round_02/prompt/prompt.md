...
- Right Hand: required contact with target object 'bathroom faucet'. Use #FF0000 / RGB(255, 0, 0) (pure red). SIG note: the right hand turns the bathroom faucet handle
...
The red right-hand mask is present but is too small and slightly misaligned. Please enlarge the red mask and center it precisely on the top handle of the bathroom faucet where the hand is making contact in the reference image.
