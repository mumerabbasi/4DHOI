#!/usr/bin/env python3
"""Evaluate PROX diversity with Module 06's authoritative metric."""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Evaluate PROX parameter diversity through Module 06."
    )
    ...
    items = [
        (name, source_root / name / "result.pkl")
        for name in discover_prox_interactions(args.output_mode)
    ]
