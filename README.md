...
conda run -n 4dhsi python 01_Generate_SIG/01_generate_sig.py --interaction_name interaction_01
conda run -n 4dhsi python 02_Select_Target_Instance/01_select_target_instance.py --interaction_name interaction_01
conda run -n 4dhsi python 03_Generate_Human_Frame/01_build_prompt.py --interaction_name interaction_01
conda run -n 4dhsi python 03_Generate_Human_Frame/02_generate_human_frame.py --interaction_name interaction_01
conda run -n 4dhsi python 04_Estimate_Contact/01_build_prompt.py --interaction_name interaction_01
conda run -n 4dhsi python 04_Estimate_Contact/02_estimate_contact.py --interaction_name interaction_01
conda run -n gvhmr python 05_Estimate_Human_Pose/01_estimate_static_pose.py --interaction_name interaction_01
conda run -n 4dhsi python 06_Optimize_Static_Scene/01_optimize_static_scene.py --interaction_name interaction_01
```

The input file for each scene is:

```text
01_Generate_SIG/input_prompts/<interaction_name>/input_scene.json
```
