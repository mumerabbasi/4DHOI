...
You will always receive 4 different rendered views of the same optimized scene. Use all 4 views together. A pose problem does not need to be visible in every view, and a single unclear or occluded view should not dominate the judgment.
