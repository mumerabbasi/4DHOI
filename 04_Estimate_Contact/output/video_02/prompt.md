...
Left Hand: Mark this contact region on the object surface using a precise pure magenta overlay.
Right Hand: Mark this contact region on the object surface using a precise pure lime green overlay.
