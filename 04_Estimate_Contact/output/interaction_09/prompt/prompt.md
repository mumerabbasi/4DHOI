...
Left Hand: The left hand is in contact with the target object. Copy the visible left hand mask shape from the Reference Image onto the matching location in the returned overlay image using solid #00FFFF / RGB(0, 255, 255) (pure cyan).
...
Left Arm: The left arm is in contact with the target object. Copy the visible left arm mask shape from the Reference Image onto the matching location in the returned overlay image using solid #FFFF00 / RGB(255, 255, 0) (pure yellow).
Right Arm: The right arm is in contact with the target object. Copy the visible right arm mask shape from the Reference Image onto the matching location in the returned overlay image using solid #0000FF / RGB(0, 0, 255) (pure blue).
