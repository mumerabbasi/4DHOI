...
Hips: If the target object is touched by the hips in the Reference Image, copy the visible hips mask shape from the Reference Image onto the matching location in the Canvas Image using a precise bright violet overlay.
