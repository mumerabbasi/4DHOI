...
\begin{figure}[t]
  ...
  \fbox{%
    \begin{minipage}[c][0.28\textheight][c]{0.94\textwidth}
      ...
      \quad$\rightarrow$\quad final masks $\Omega_e^{\mathrm{2D}}$
...
\end{equation}
already expressed in the ScanNet++ scene coordinate frame. The stage lengths, learning rate, gradient clipping, and total iteration budget are reported in \cref{sec:implementation-details}.