"""Mesh-to-depth alignment using one-way chamfer losses on a fixed visible subset.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output_root",
        type=str,
        default="./output_scale_txyz_chamfer_visible",
...
def main() -> None:
    ...
    summary_out = {
        ...
        "energy_terms": {
            ...
            "L_cd3d_raw": "mean_{o in O3D} min_{m in M3D_vis'} ||o-m||_2^2",
            "L_cd3d": "GemanMcClure(L_cd3d_raw)",
            "L_cd2d": "mean_{o in O2D} min_{m in M2D_vis'} ||o-m||_2^2",
            "L_scale_reg": "alpha^2",
