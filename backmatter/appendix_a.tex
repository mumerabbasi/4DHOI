...
\begin{table}[h]
  ...
  \begin{tabularx}{\textwidth}{@{}>{\bfseries}p{0.24\textwidth}X@{}}
    ...
    \(\Pi_{\mathrm{agentic}}\) & Agentic contact verification \\
...
\subsection[Agentic Contact-Verification Prompt (Pi\_agentic)]{Agentic Contact-Verification Prompt \(\Pi_{\mathrm{agentic}}\)}
