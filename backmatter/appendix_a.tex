...
\begin{table}[t]
  \centering
  \caption{The shared $1$-to-$5$ scale used for all four rubric criteria.}
  \label{tab:vlm-scale}
...
\begin{table}[t]
  \centering
  \caption{The four rubric criteria and their scoring rules. Each criterion is scored on the scale of \cref{tab:vlm-scale}, subject to the caps listed.}
