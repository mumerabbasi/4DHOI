...
This appendix records the prompts used by the foundation-model stages of the method and by the vision-language evaluation. The symbols below are used in the methodology and experiments chapters.
 
\begin{table}[h]
  \centering
  \caption[Prompt symbols.]{Prompt symbols used in the methodology and experiments chapters.}
  ...
  \begin{tabularx}{\textwidth}{@{}>{\bfseries}p{0.24\textwidth}X@{}}
    ...
    \(\Pi_{\mathrm{con\_eval}}\) & Agentic contact verification \\
    \(\Pi_{\mathrm{eval}}\) & Interaction rubric evaluation \\
    \bottomrule
  \end{tabularx}
\end{table}
...
\subsection[Interaction Rubric Evaluation Prompt (Pi\_eval)]{Interaction Rubric Evaluation Prompt \(\Pi_{\mathrm{eval}}\)}
...
\begin{table}[t]
  ...
  \begin{tabularx}{\textwidth}{@{}>{\bfseries}p{0.24\textwidth}X@{}}
    ...
    Whether the instruction-relevant body parts plausibly contact, grip, rest on, press, or lie appropriately close to the correct object region. Visual overlap alone is not accepted as contact. Hidden or ambiguous contact, or clearly floating support, caps the score at $3$; severe penetration of the target object caps it at $2$; a score of $5$ requires all instruction-specified contacts to be clearly plausible. \\
    \addlinespace
    Physical plausibility &
    Whether the body--object arrangement has plausible support, balance, placement, and collision behavior. Floating support caps the score at $3$; severe penetration of the target object or a nearby solid caps it at $2$; torso, pelvis, or multi-limb penetration receives $1$ or $2$; any visible floating, major penetration, impossible balance, or nonsensical support rules out a score of $5$. \\
    \bottomrule
  \end{tabularx}
\end{table}
...
\begingroup
    ...
    \newcommand{\aqrow}[2]{%
      \begin{minipage}[c]{\linewidth}\footnotesize\centering
        #2\par\smallskip
        \includegraphics[width=\linewidth,height=\aqcellh,keepaspectratio]{figures/qualitative/#1_frame.jpg}
      \end{minipage} &
      \includegraphics[width=\aqcellw,height=\aqcellh,keepaspectratio]{figures/qualitative/#1_ours1.jpg} &
      \includegraphics[width=\aqcellw,height=\aqcellh,keepaspectratio]{figures/qualitative/#1_ours2.jpg} &
      \includegraphics[width=\aqcellw,height=\aqcellh,keepaspectratio]{figures/qualitative/#1_single1.jpg} &
      \includegraphics[width=\aqcellw,height=\aqcellh,keepaspectratio]{figures/qualitative/#1_single2.jpg} &
      \includegraphics[width=\aqcellw,height=\aqcellh,keepaspectratio]{figures/qualitative/#1_physic1.jpg} &
      \includegraphics[width=\aqcellw,height=\aqcellh,keepaspectratio]{figures/qualitative/#1_physic2.jpg} \\
      \addlinespace[4pt]}
    \newcommand{\aqheader}{%
      \toprule
  ...
  \begin{figure}[p]
    ...
    \begin{tabular}{@{}p{0.17\linewidth} cc cc cc@{}}
      ...
      \bottomrule
    \end{tabular}
    \caption[Additional qualitative comparisons.]{Additional qualitative comparisons for the fourteen interactions not shown in the main gallery. The layout follows \cref{fig:exp-qualitative-gallery}: the leftmost cell contains the exact interaction instruction and generated human frame, followed by two views each for the full method, the single-shot setting, and PhySIC.}
