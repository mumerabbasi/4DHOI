...
\begin{table}[h]
  \centering
  \caption[Prompt symbols.]{Prompt symbols used in the methodology.}
...
The reported per-interaction score is the mean of the four criterion scores, and the dataset-level scores are the means of the per-interaction values, computed independently for each criterion and for the mean. The full prompt given to the evaluator is reproduced together with the other foundation-model prompts in \cref{app:foundation-model-prompts}.