...
This section complements the nine interactions shown in the main qualitative galleries with the remaining fourteen evaluation interactions, in their evaluation-set order. \Cref{fig:app-qualitative-ablation} compares GVHMR init, Single-shot, and Full method, following \cref{fig:exp-qualitative-ablation}; \cref{fig:app-qualitative-baseline} compares PhySIC and Full method, following \cref{fig:exp-qualitative-baseline}. Every setting is shown from the same two selected views, and the method names match \cref{tab:exp-quantitative}.
...
\begingroup
  ...
  \begin{figure}[p]
    ...
    \small
    \begin{tabular}{@{}p{0.16\linewidth} cc cc cc@{}}
      \qualablationheader
      \qualablationrow{table}{1}{Sitting on the wooden table}
      \qualablationrow{chair}{2}{Pulling back the chair}
      \bottomrule
    \end{tabular}
    \caption[Additional qualitative ablation comparisons.]{Additional qualitative ablation comparisons for the fourteen appendix interactions. The leftmost cell identifies the interaction; the remaining columns show two views each for GVHMR init, Single-shot, and Full method. Complete instructions are given in \cref{tab:exp-interactions}.}
    \label{fig:app-qualitative-ablation}
  \end{figure}
  ...
  \begin{figure}[p]
    ...
    \begin{tabular}{@{}p{0.16\linewidth} cc cc cc@{}}
      \qualablationheader
      \qualablationrow{door}{3}{Opening the door}
      \qualablationrow{faucet}{4}{Turning on the faucet}
      \bottomrule
    \end{tabular}
    \caption[]{Additional qualitative ablation comparisons (continued).}
  \end{figure}
  ...
  \begin{figure}[p]
    ...
    \begin{tabular}{@{}p{0.16\linewidth} cc cc cc@{}}
      \qualablationheader
      \qualablationrow{washingmachine}{5}{Opening the washing machine}
      \qualablationrow{coffee}{7}{Making coffee}
      \bottomrule
    \end{tabular}
    \caption[]{Additional qualitative ablation comparisons (continued).}
  \end{figure}
  ...
  \begin{figure}[p]
    ...
    \begin{tabular}{@{}p{0.16\linewidth} cc cc cc@{}}
      \qualablationheader
      \qualablationrow{shower}{8}{Taking a shower}
      \qualablationrow{vacuum}{9}{Taking out the vacuum cleaner}
      \bottomrule
    \end{tabular}
    \caption[]{Additional qualitative ablation comparisons (continued).}
  \end{figure}
  ...
  \begin{figure}[p]
    ...
    \begin{tabular}{@{}p{0.16\linewidth} cc cc cc@{}}
      \qualablationheader
      \qualablationrow{sofaplant}{12}{Sitting beside the sofa and plant}
      \qualablationrow{shelf}{13}{Sitting on the shelf}
      \bottomrule
    \end{tabular}
    \caption[]{Additional qualitative ablation comparisons (continued).}
  \end{figure}
  ...
  \begin{figure}[p]
    ...
    \begin{tabular}{@{}p{0.16\linewidth} cc cc cc@{}}
      \qualablationheader
      \qualablationrow{lamp}{15}{Reaching for the bedside lamp}
      \qualablationrow{chocolate}{16}{Reaching for the chocolate}
      \bottomrule
    \end{tabular}
    \caption[]{Additional qualitative ablation comparisons (continued).}
  \end{figure}
  ...
  \begin{figure}[p]
    ...
    \begin{tabular}{@{}p{0.16\linewidth} cc cc cc@{}}
      \qualablationheader
      \qualablationrow{drawer}{18}{Opening the lower drawer}
      \qualablationrow{treadmill}{22}{Running on the treadmill}
      \bottomrule
    \end{tabular}
    \caption[]{Additional qualitative ablation comparisons (continued).}
  \end{figure}
  ...
  \begin{figure}[p]
    ...
    \setlength{\tabcolsep}{3pt}
    \small
    \begin{tabular}{@{}p{0.16\linewidth} cc cc@{}}
      \qualbaselineheader
      \qualbaselinerow{table}{1}{Sitting on the wooden table}
      \qualbaselinerow{chair}{2}{Pulling back the chair}
      \bottomrule
    \end{tabular}
    \caption[Additional qualitative baseline comparisons.]{Additional qualitative baseline comparisons for the fourteen appendix interactions. The leftmost cell identifies the interaction; the remaining columns show two views each for PhySIC and Full method. Complete instructions are given in \cref{tab:exp-interactions}.}
    \label{fig:app-qualitative-baseline}
  \end{figure}
  ...
  \begin{figure}[p]
    ...
    \begin{tabular}{@{}p{0.16\linewidth} cc cc@{}}
      \qualbaselineheader
      \qualbaselinerow{door}{3}{Opening the door}
      \qualbaselinerow{faucet}{4}{Turning on the faucet}
      \bottomrule
    \end{tabular}
    \caption[]{Additional qualitative baseline comparisons (continued).}
  \end{figure}
  ...
  \begin{figure}[p]
    ...
    \begin{tabular}{@{}p{0.16\linewidth} cc cc@{}}
      \qualbaselineheader
      \qualbaselinerow{washingmachine}{5}{Opening the washing machine}
      \qualbaselinerow{coffee}{7}{Making coffee}
      \bottomrule
    \end{tabular}
    \caption[]{Additional qualitative baseline comparisons (continued).}
  \end{figure}
  ...
  \begin{figure}[p]
    ...
    \begin{tabular}{@{}p{0.16\linewidth} cc cc@{}}
      \qualbaselineheader
      \qualbaselinerow{shower}{8}{Taking a shower}
      \qualbaselinerow{vacuum}{9}{Taking out the vacuum cleaner}
      \bottomrule
    \end{tabular}
    \caption[]{Additional qualitative baseline comparisons (continued).}
  \end{figure}
  ...
  \begin{figure}[p]
    ...
    \begin{tabular}{@{}p{0.16\linewidth} cc cc@{}}
      \qualbaselineheader
      \qualbaselinerow{sofaplant}{12}{Sitting beside the sofa and plant}
      \qualbaselinerow{shelf}{13}{Sitting on the shelf}
      \bottomrule
    \end{tabular}
    \caption[]{Additional qualitative baseline comparisons (continued).}
  \end{figure}
  ...
  \begin{figure}[p]
    ...
    \begin{tabular}{@{}p{0.16\linewidth} cc cc@{}}
      \qualbaselineheader
      \qualbaselinerow{lamp}{15}{Reaching for the bedside lamp}
      \qualbaselinerow{chocolate}{16}{Reaching for the chocolate}
      \bottomrule
    \end{tabular}
    \caption[]{Additional qualitative baseline comparisons (continued).}
  \end{figure}
  ...
  \begin{figure}[p]
    ...
    \begin{tabular}{@{}p{0.16\linewidth} cc cc@{}}
      \qualbaselineheader
      \qualbaselinerow{drawer}{18}{Opening the lower drawer}
      \qualbaselinerow{treadmill}{22}{Running on the treadmill}
      \bottomrule
    \end{tabular}
    \caption[]{Additional qualitative baseline comparisons (continued).}
  \end{figure}
