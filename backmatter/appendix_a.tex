...
\begingroup
    ...
    \newlength{\aqcellh}\setlength{\aqcellh}{0.08\linewidth}%
    \newcommand{\aqrow}[2]{%
      \begin{minipage}[c]{\linewidth}\footnotesize\centering
        #2\par\smallskip
        \includegraphics[width=\linewidth,height=\aqcellh,keepaspectratio]{figures/qualitative/#1_frame.png}
      \end{minipage} &
      \includegraphics[width=\aqcellw,height=\aqcellh,keepaspectratio]{figures/qualitative/#1_ours1.png} &
      \includegraphics[width=\aqcellw,height=\aqcellh,keepaspectratio]{figures/qualitative/#1_ours2.png} &
      \includegraphics[width=\aqcellw,height=\aqcellh,keepaspectratio]{figures/qualitative/#1_single1.png} &
      \includegraphics[width=\aqcellw,height=\aqcellh,keepaspectratio]{figures/qualitative/#1_single2.png} &
      \includegraphics[width=\aqcellw,height=\aqcellh,keepaspectratio]{figures/qualitative/#1_physic1.png} &
      \includegraphics[width=\aqcellw,height=\aqcellh,keepaspectratio]{figures/qualitative/#1_physic2.png} \\
      \addlinespace[4pt]}
    \newcommand{\aqheader}{%
      \toprule
