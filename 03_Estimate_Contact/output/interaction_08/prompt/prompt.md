...
Left Hand: The left hand is in contact with the target object. Copy the visible left hand mask shape from the Reference Image onto the matching location in the returned overlay image using solid #FF00FF / RGB(255, 0, 255) (pure magenta).
Right Hand: The right hand is in contact with the target object. Copy the visible right hand mask shape from the Reference Image onto the matching location in the returned overlay image using solid #00FFFF / RGB(0, 255, 255) (pure cyan).
