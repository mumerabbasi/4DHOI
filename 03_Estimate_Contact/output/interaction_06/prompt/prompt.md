...
Right Hand: The right hand is in contact with the target object. Copy the visible right hand mask shape from the Reference Image onto the matching location in the returned overlay image using solid #FFFF00 / RGB(255, 255, 0) (pure yellow).
