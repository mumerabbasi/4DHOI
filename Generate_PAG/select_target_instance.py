...
def resolve_selection_dir(output_root: Path) -> Path:
    return output_root / "selection"
...
def main() -> None:
    ...
    selection_dir = resolve_selection_dir(output_root)
    ...
    selection_json_path = selection_dir / "target_selection.json"
