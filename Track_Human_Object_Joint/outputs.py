...
def _scheduled_weights_summary(args: argparse.Namespace) -> dict[str, dict[str, float]]:
    return {
        "reprojection": {"fixed": float(args.tracking_weight)},
        "object_cd2d": {
...
def save_run_outputs(
    ...
    summary = {
        ...
        "status": "completed",
        "script": "track_human_object_joint.py",
        "num_frames": context.num_frames,
        ...
        "inputs": {
            ...
            "cotracker_video_dir": str(context.dirs["cotracker"]),
            "segment_object_dir": str(context.dirs["seg_obj"]),
            "segment_video_dir": str(context.dirs["seg_vid"]),
        ...
        "optimisation": {
            ...
            "pnp_ransac_thresh": args.pnp_ransac_thresh,
            "disable_pnp_init": bool(args.disable_pnp_init),
            "outlier_reproj_thresh_px": args.outlier_reproj_thresh_px,
        ...
        "objects": {
            slug: {
                ...
                "cotracker_seed_points": int(context.objects[slug].track_seed_count),
                "cotracker_valid_points": int(context.objects[slug].track_valid_count),
                "is_translational": (
