...
Interaction:
A person sits on the edge of the bed like sitting in a chair, with the hips supported by the mattress and both feet planted on the floor. The torso leans outward while the right hand reaches toward the nearby Milka chocolate. The person has short black hair, a casual focused expression, a gray shirt, comfortable pants, and socks.
