...
Interaction:
A person stands beside the bicycle, holding it with both hands while one foot pushes the bicycle kick-stand to remove it from support. The other foot stays on the floor for balance. The person has short dark hair, a focused expression, a casual top, long pants, and sneakers.
